...
const tilesEven = reachablePositionsArray.filter(({ x, y }) => {
  return size <= x && x < 2 * size && 2 * size <= y && y < 3 * size;
}).length;

console.log("tilesOdd", tilesOdd, "tilesEven", tilesEven);
...
const result = tilesFullMaps + corners + almostFullEdges + almostEmptyEdges;

// x < 615066203655018 < 615067001132434
// x != 575041651574742, 614861958744742
console.log(result); // 614864614526014
